...
<div id="statsContainer">
	<h1>Accounts created on Memsoria.pl</h1>
	<div class="liner"></div>
	<br />
	<div style="font-weight: bold; position: absolute; margin-left: 32px; margin-top: -20px;">Day</div>
	<div style="font-weight: bold; position: absolute; margin-left: 330px; margin-top: -20px;">Ammount of new accounts</div>
</div>
<div class="alert alert-info">
This chart contains information on the accounts created within last thirty days.
</div>
<ul class="pager">
  <li class="previous">
...
d3.json('http://memsoria.pl/m/engine/ajax/accounts.php', function (blad, json) {
	if (blad) {
	...
	var wykres = d3.select('#statsContainer')
			...
			.attr('height', config.wysokoscWykresu);
